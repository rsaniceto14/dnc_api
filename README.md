...
Desenvolvimento de uma API em laravel com endpoint de inserção e consulta de dados.
...
Para uso do projeto deve ser criado o database. 

nome do banco utilizado (db_dnc), configurado no arquivo .env
